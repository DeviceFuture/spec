...
| Product(s) (if any) or area | [Product names[G1]/Area[G2]] |
| Author(s) | [Emails of author(s)] |
| Reviewer(s) (if any) | [Emails of reviewer(s)[G1]] |
| Submission date | [YYYY-MM-DD] |
| Acceptance date | [YYYY-MM-DD[G1]] |
| Addresses issue(s) (if any) | [Link to issues[G1][G3]] |
